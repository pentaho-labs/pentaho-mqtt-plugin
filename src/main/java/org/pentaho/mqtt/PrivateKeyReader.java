 ...
 * https://github.com/chrismessina/oauth/blob/master/code/java/jmeter/jmeter/src/main/java/org/apache/jmeter/protocol/oauth/sampler/PrivateKeyReader.java
 *
 * Modifications to original source code Copyright (C) 2016 by Pentaho:
